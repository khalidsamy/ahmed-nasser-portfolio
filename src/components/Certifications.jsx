      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <motion.div
          ...
          <div className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-blue-100/60 dark:bg-blue-900/30 rounded-full border border-blue-200 dark:border-blue-800/50 mb-4">
            ...
            <span className="text-sm font-semibold text-blue-700 dark:text-blue-400">Verified Credentials</span>
          </div>
        </motion.div>
        ...
        <motion.h2
          ...
          <span className="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent">Certifications</span>
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          {certifications.map((cert, index) => (
            <motion.a
              ...
              <div className="relative bg-white dark:bg-slate-800 rounded-3xl shadow-lg dark:shadow-xl group-hover:shadow-2xl dark:group-hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-200 dark:border-slate-700 flex flex-col h-full">
                ...
                <div className={`relative bg-gradient-to-br ${cert.color} flex items-center justify-center p-6 overflow-hidden min-h-64`}>
                  {/* Decorative background elements */}
                  ...
                  <div className="absolute top-4 right-4 z-20">
                    <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm px-3 py-1 rounded-full flex items-center gap-1.5 shadow-lg">
                      ...
                      <span className="text-xs font-bold text-gray-900 dark:text-white">{cert.badge}</span>
                    </div>
                  </div>
                  ...
                  <div className="relative z-10">
                    <img
                      src={cert.image}
                      alt={cert.issuer}
                      className="h-48 max-h-64 w-auto object-contain filter drop-shadow-lg group-hover:scale-110 transition-transform duration-500"
                    />
                  </div>
                </div>
                ...
                <div className="p-6 flex-1 flex flex-col justify-between bg-white dark:bg-slate-800">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <div className={`h-1 w-8 bg-gradient-to-r ${cert.color} rounded-full`}></div>
